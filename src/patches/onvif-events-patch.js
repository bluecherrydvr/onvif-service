/**
 * Patch for the ONVIF library's event handling
...
// Store the original pullMessages function
const originalPullMessages = onvif.Cam.prototype.pullMessages;

// Override the pullMessages function to ensure the callback context is preserved
...
// Store the original createPullPointSubscription function
const originalCreatePullPointSubscription = onvif.Cam.prototype.createPullPointSubscription;

// Override the createPullPointSubscription function
...
// Store the original unsubscribe function
const originalUnsubscribe = onvif.Cam.prototype.unsubscribe;

// Override the unsubscribe function
